...
def mean_squared_error(predicted: np.ndarray, target: np.ndarray) -> np.complex64:
    """
    ...
    return np.complex64(real_error, imag_error)

def cross_entropy(predicted: np.ndarray, target: np.ndarray) -> np.complex64:
    """
    ...
    return np.mean(loss, dtype=np.complex64)

def binary_cross_entropy(predicted: np.ndarray, target: np.ndarray) -> np.complex64:
    """
...
def categorical_cross_entropy(predicted: np.ndarray, target: np.ndarray) -> np.complex64:
    """
...
def mean_absolute_error(predicted: np.ndarray, target: np.ndarray) -> np.complex64:
    """
...
def huber_loss(predicted: np.ndarray, target: np.ndarray, delta: float = 1.0) -> np.complex64:
    """

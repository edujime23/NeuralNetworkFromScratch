...
class NetworkIO:
    ...
    def load(filepath: str) -> NeuralNetwork:
        ...
        try:
            ...
            layers_types = [NetworkIO._get_layer_class(name) for name in network_data["layers_types"]]
            ...
            network = NeuralNetwork(sizes, layers_types, activation_functions, cost_function, threshold, dropout_rate, batch_norm, gradient_clip)
